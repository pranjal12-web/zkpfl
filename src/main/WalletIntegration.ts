...
const handleWalletConnect = (connect: Promise<ConnectedWallet>) => {
  ...
  connect
    .then((userAccount) => {
      ...
      console.log(updateInteractionVisibility);
    ...
    .catch((error) => {
      if ("message" in error) {
        ...
        console.log("eror 2 enteered");
        setConnectionStatus("An error occurred trying to connect wallet: " + error);
      }
    });
};

// import { ConnectedWallet } from 'partisia-sdk';

// export const makeTransactionToAddress = async (recipientAddress: string, amount: number): Promise<void> => {
//   try {
//     // Check if a connected wallet exists
//     if (!account) {
...
//       amount: amount,
//       // Add any additional transaction details as needed
//     };

//     // Call the function to open the wallet and make the transaction
//     const transactionResult =  connectMpcWalletClick();

//     // Handle the transaction result
//     if (transactionResult.putSuccessful) {
//       // Transaction was successful, update UI or perform any other actions
//       console.log('Transaction successful');
//     } else {
//       // Transaction failed, handle the error or notify the user
//       console.log('Transaction failed');
//     }
//   } catch (error) {
//     // Handle errors
//     console.error('Error making transaction:', error);
//     // You can choose to log the error, display a message to the user, or take other actions
//   }
// };
